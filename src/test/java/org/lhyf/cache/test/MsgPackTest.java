 ...
 * @desc MsgPackTest
 *
 * To write a byte array, first you call packBinaryHeader(int) method with length of the byte array.
 * Then, you call writePayload(byte[], int, int) or addPayload(byte[], int, int) method to write the contents.
 *
 * To write a List, Collection or array, first you call packArrayHeader(int) method with the number of elements.
 * Then, you call packer methods for each element. iteration.
 *
 * To write a Map, first you call packMapHeader(int) method with size of the map.
 * Then, for each pair, you call packer methods for key first, and then value. You will call packer methods twice as many time as the size of the map.
 *
...
//        users.add(new User(1,"AA","aa",new Date()));
//        users.add(new User(2,"BB","bb",new Date()));
//        users.add(new User(3,"CC","cc",new Date()));
//        users.add(new User(4,"DD","dd",new Date()));
//
//        packer.pack
        packer.packArrayHeader(4).packFloat(0.1f).packDouble(0.342);
        packer.close();
